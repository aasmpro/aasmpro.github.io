export const projects = [
  {
    ...
    about: [
      "Starter to intermediate python 3 tutorial with examples. i had started this project as a source document for my classes.",
    ...
    link: "https://abolfazlamiri.ir/python3tutorials/",
    bgColor: "bg-blue-0",
  ...
  },
  {
    ...
    about: [
      "This is a Django util for managing app settings, like how DjangoRestFramework do it.",
    ...
    showProjects: true,
    showExperiences: true,
    link: "https://github.com/aasmpro/django-zero-settings",
    bgColor: "bg-green-0",
  ...
  },
  {
    title: "GruvDoc",
    about: [
      "This is pre-configured MkDocs project with all the must useful extensions and tweaks needed, just Fork, Change and Push!",
    ...
    showProjects: true,
    showExperiences: true,
    link: "https://abolfazlamiri.ir/gruvdoc/",
    bgColor: "bg-green-0",
    ringColor: "ring-green-0",
  },
  {
    ...
    showProjects: true,
    showExperiences: true,
    link: "https://github.com/aasmpro/djangosmartshare",
    bgColor: "bg-green-0",
    ringColor: "ring-green-0",
  },
  {
    ...
    showProjects: true,
    showExperiences: true,
    link: "https://github.com/aasmpro/simplesm",
    bgColor: "bg-blue-0",
    ringColor: "ring-blue-0",
  },
  {
    ...
    showProjects: true,
    showExperiences: true,
    link: "https://github.com/aasmpro/simplesocket",
    bgColor: "bg-blue-0",
    ringColor: "ring-blue-0",
  },
  {
    ...
    showProjects: true,
    showExperiences: true,
    link: "https://github.com/aasmpro/xurl",
    bgColor: "bg-dark-0",
  ...
  },
  {
    ...
    link: "https://abolfazlamiri.ir/dotfiles/",
    bgColor: "bg-dark-0",
    ringColor: "ring-dark-0",
  },
  {
    ...
    showProjects: true,
    showExperiences: true,
    link: "https://abolfazlamiri.ir/randomize/",
    bgColor: "bg-red-0",
  ...
  },
  {
    title: "Truth or Dare",
    about: [
      "Time for Fun again?! well this project lets you play truth-or-dare without a bottle (it's always hard to spin a bottle).",
    ],
    ...
    showProjects: true,
    showExperiences: true,
    link: "https://abolfazlamiri.ir/truthordare/",
    bgColor: "bg-red-0",
    ringColor: "ring-red-0",
  },
  {
    ...
    showProjects: true,
    showExperiences: false,
    link: "https://github.com/aasmpro/svpn",
    bgColor: "bg-dark-0",
    ringColor: "ring-dark-0",
  },
  {
    ...
    about: [
      "This is a simple game in which you should hunt the wumpus without being eaten or falling in pits. it is mostly shown as an example for AI courses. here you can play the game or write a code that plays the game using its APIs.",
    ],
    ...
    showProjects: true,
    showExperiences: false,
    link: "https://abolfazlamiri.ir/huntthewumpus/",
    bgColor: "bg-red-0",
    ringColor: "ring-red-0",
  },
  {
    ...
    showProjects: false,
    showExperiences: false,
    link: "https://github.com/aasmpro/behdar",
  },
  {
  ...
  },
  {
    ...
    showProjects: true,
    showExperiences: false,
    link: "https://melikaamirhoseini.ir",
    bgColor: "bg-orange-0",
    ringColor: "ring-orange-0",
  },
  {
